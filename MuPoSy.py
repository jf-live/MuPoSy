...
########        WORK ON MEL Part 2: CHANGE THE MELODY IN SYNCH WITH DEMO MODE - DONE
########        FIX THE CHANGE OF KEY FOR NOTES, AND SYNCH WITH DEMO MODE WHEN APPLICABLE - DONE
########        FIGURE OUT THE CAUSE OF THE AUDIO CUT, VERY LIKELY RELATED
########            TO AUDIO EXPLODING (EXTREME NOISE OF DEATH IS HOWEVER
########            PREVENTED, I BELIEVE, BY CLIP OBJECT)
